...
\begin{center}
\IfFileExists{autoencoder.png}{\includegraphics[width=0.92\linewidth]{autoencoder.png}}{\fbox{\parbox{0.92\linewidth}{\centering \small autoencoder.png (absent)}}}
\end{center}
...
\begin{center}
\IfFileExists{autoencoder-denoising.png}{\includegraphics[width=0.92\linewidth]{autoencoder-denoising.png}}{\fbox{\parbox{0.92\linewidth}{\centering \small autoencoder-denoising.png (absent)}}}
\end{center}
