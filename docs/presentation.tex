...
\titlegraphic{%
  \vspace{-0.3cm}%
  \IfFileExists{../assets/logos/institut_logo.jpg}{\includegraphics[height=1.1cm,keepaspectratio]{institut_logo.jpg}}{}\hspace{0.6cm}%
  \IfFileExists{../assets/logos/logo_craste-lf.png}{\includegraphics[height=1.1cm,keepaspectratio]{logo_craste-lf.png}}{}\hspace{0.6cm}%
  \IfFileExists{../assets/logos/logo_onu.png}{\includegraphics[height=1.1cm,keepaspectratio]{logo_onu.png}}{}%
}
...
\begin{frame}[plain]
  ...
  \hbox to \linewidth{%
    \IfFileExists{../assets/logos/logo_onu.png}{\includegraphics[height=1.1cm,keepaspectratio]{logo_onu.png}}{}%
    \hspace{0.35cm}%
    \IfFileExists{../assets/logos/logo_craste-lf.png}{\includegraphics[height=1.1cm,keepaspectratio]{logo_craste-lf.png}}{}%
    \hfil%
    \IfFileExists{../assets/logos/institut_logo.jpg}{\includegraphics[height=1.1cm,keepaspectratio]{institut_logo.jpg}}{}%
  }
...
\begin{columns}[T,onlytextwidth]
  ...
  \IfFileExists{../assets/figures/demo_noisy.png}{%
    ...
    \IfFileExists{../assets/figures/demo_mnist_noisy.png}{%
      \includegraphics[width=\linewidth]{demo_mnist_noisy.png}\\
    }{%
  ...
  \IfFileExists{../assets/figures/demo_denoised.png}{%
    ...
    \IfFileExists{../assets/figures/demo_mnist_denoised.png}{%
      \includegraphics[width=\linewidth]{demo_mnist_denoised.png}\\
    }{%
  ...
  \IfFileExists{../assets/figures/demo_clean.png}{%
    ...
    \IfFileExists{../assets/figures/demo_mnist_clean.png}{%
      \includegraphics[width=\linewidth]{demo_mnist_clean.png}\\
    }{%
